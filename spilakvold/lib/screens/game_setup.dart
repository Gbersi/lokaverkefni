  ...
  void _startGame() {
    if (_players.isNotEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Vinsamlegast bætu við einum spilara til að byrja leikinn!'),
        ),
      );
    }
  }
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Sláðu inn nafn Leikmanns',
                ...
                ElevatedButton(
                  ...
                  child: const Text('Bæta við spilara'),
                ),
                const SizedBox(height: 20),
                if (_players.isNotEmpty) ...[
                  Text(
